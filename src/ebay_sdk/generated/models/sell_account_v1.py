...
class AdvertisingProgramEnum(EbayModel):
    pass
...
class CustomPolicyTypeEnum(EbayModel):
    pass


class DetailsType(EbayModel):
    pass
...
class PaymentInstrumentBrandEnum(EbayModel):
    pass
...
class PaymentsProgramOnboardingStatus(EbayModel):
    pass


class PaymentsProgramOnboardingStepStatus(EbayModel):
    pass
...
class PaymentsProgramStatus(EbayModel):
    pass


class PaymentsProgramType(EbayModel):
    pass


class ProgramTypeEnum(EbayModel):
    pass


class RecipientAccountReferenceTypeEnum(EbayModel):
    pass
...
class SellerEligibilityEnum(EbayModel):
    pass


class SellerIneligibleReasonEnum(EbayModel):
    pass


class ShippingCostTypeEnum(EbayModel):
    pass


class ShippingOptionTypeEnum(EbayModel):
    pass


class SubscriptionTypeEnum(EbayModel):
    pass
